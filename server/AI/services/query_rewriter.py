...
from AI.services.prompts import QUERY_REWRITER_SYSTEM
...
class QueryRewriter:
    ...
    def rewrite(self, messages: list[Message]) -> str:
        ...
        rewrite_messages = [
            Message(
                ...
                content=(
                    ...
                    "for a UMES knowledge base. Resolve pronouns and vague references "
        ...
        rewritten = self._llm.generate(
            rewrite_messages, system=QUERY_REWRITER_SYSTEM
        ).strip()
